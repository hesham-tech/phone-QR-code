// =============================================
// منطق Contact Picker API (نسخة مُحسَّنة)
// =============================================

// تغليف جميع المنطق لضمان تنفيذه بعد تحميل DOM
document.addEventListener("DOMContentLoaded", () => {
  // الآن يمكننا البحث عن العناصر بأمان
  const contactPickerBtn = document.getElementById("contactPickerBtn");
  const phoneInput = document.getElementById("phone");

  // يجب التحقق من وجود الزر قبل محاولة ربطه
  if (!contactPickerBtn) {
    console.error("Contact Picker Button (contactPickerBtn) not found in DOM.");
    return;
  }
  ...
  async function selectContact() {
    ...
    try {
      ...
      // نفترض أن دالة clearQR موجودة في script.js وتم تحميلها عالميًا
  ...
  // ----------------------------------------------------
  // 3. ربط الحدث (يتم الآن ربطه بعد التأكد من وجود الزر)
  // ----------------------------------------------------
